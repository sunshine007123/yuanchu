package com.chuyuan.action.aloud;
import java.io.File;
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            for (FileItem fi : fileItems) {
            	...
            	fileName = sdf.format(new Date())+fi.getName().substring(fi.getName().lastIndexOf("."),fi.getName().length());
        ...
        //获取图片url地址
        String imgUrl = "http://localhost:8080/chuyuan/image/" + fileName;
